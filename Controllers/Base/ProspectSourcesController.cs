...
namespace Ellucian.Colleague.Api.Controllers
{
    ...
    public class ProspectSourcesController : BaseCompressedApiController
    {
        ...
        public ProspectSourcesController(IAdapterRegistry adapterRegistry, IReferenceDataRepository referenceDataRepository, IActionContextAccessor actionContextAccessor, ApiSettings apiSettings) : base(actionContextAccessor, apiSettings)
        {
        ...
        [HttpGet]
        [HeaderVersionRoute("/prospect-sources", 1, true, Name = "GetProspectSources")]
